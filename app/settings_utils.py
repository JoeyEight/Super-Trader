...
SANITIZER_DEFAULTS: Dict[str, Any] = {
    ...
    "openai_decision_max_candidates_per_market": 3,
    "openai_decision_min_interval_s": 0.0,
    "openai_decision_max_calls_per_day": 24,
    "openai_decision_max_calls_per_week": 120,
    "openai_decision_live_enabled": True,
    "openai_decision_paper_enabled": True,
    "openai_decision_require_local_pass_first": True,
    "openai_managed_auto_tuning_enabled": False,
    "openai_nightly_review_enabled": False,
    "openai_nightly_review_hour_local": 2,
    "openai_nightly_review_lookback_days": 7,
    "openai_nightly_review_model": "gpt-5.4-mini",
    "openai_nightly_review_timeout_s": 12.0,
    "openai_nightly_review_max_events": 5000,
    "openai_nightly_review_max_suggestions": 12,
    ...
    "openai_position_review_max_positions": 48,
    "openai_capital_planner_enabled": False,
    "openai_capital_planner_interval_s": 180.0,
    "openai_capital_planner_model": "gpt-5.4-mini",
    "openai_capital_planner_timeout_s": 6.0,
    "openai_capital_planner_max_candidates_per_market": 3,
    "openai_capital_planner_live_enabled": True,
    "openai_capital_planner_paper_enabled": True,
    "openai_root_cause_enabled": False,
    "openai_root_cause_interval_s": 240.0,
    "openai_root_cause_model": "gpt-5.4-mini",
    "openai_root_cause_timeout_s": 8.0,
    "openai_root_cause_live_enabled": True,
    "openai_root_cause_max_incidents": 300,
    "openai_explanations_enabled": False,
    "openai_explanations_model": "gpt-5.4-mini",
    "openai_explanations_interval_s": 3600.0,
    "openai_explanations_timeout_s": 6.0,
    "openai_explanations_live_enabled": True,
    "openai_explanations_max_items": 18,
    "openai_strategy_optimizer_enabled": False,
    "openai_strategy_optimizer_interval_s": 3600.0,
    "openai_strategy_optimizer_model": "gpt-5.4-mini",
    "openai_strategy_optimizer_timeout_s": 8.0,
    "openai_strategy_optimizer_live_enabled": True,
    "openai_strategy_optimizer_auto_apply_enabled": False,
    "openai_market_context_enabled": False,
    "openai_market_context_interval_s": 300.0,
    "openai_market_context_model": "gpt-5.4-mini",
    "openai_market_context_timeout_s": 6.0,
    "openai_market_context_live_enabled": True,
    "openai_market_context_max_items": 24,
    "openai_postmortem_enabled": False,
    "openai_postmortem_model": "gpt-5.4-mini",
    "openai_postmortem_interval_s": 86400.0,
    "openai_postmortem_timeout_s": 12.0,
    "openai_postmortem_max_events": 5000,
    "openai_postmortem_write_report_enabled": True,
    "openai_postmortem_auto_apply_tuning_enabled": False,
...
PROFILE_MANUAL_OVERRIDE_ALLOWLIST = {
    ...
    "stock_max_total_exposure_pct",
    "forex_max_total_exposure_pct",
    "market_max_total_exposure_pct",
    "stock_max_daily_loss_pct",
    "forex_max_daily_loss_pct",
    "max_dca_buys_per_24h",
    "dca_multiplier",
    "crypto_dynamic_target_count",
    "crypto_dynamic_scan_interval_s",
    "crypto_dynamic_rotation_cooldown_s",
    "crypto_dynamic_min_projected_edge_pct",
    "stock_scan_max_symbols",
    "forex_scan_max_pairs",
    "stock_stale_alignment_grace_cycles",
    "forex_stale_alignment_grace_cycles",
}
...
_BOOL_KEYS = {
    ...
    "crypto_replay_adaptive_enabled",
    "news_event_enabled",
    "alpaca_paper_mode",
    "oanda_practice_mode",
    ...
    "openai_decision_live_enabled",
    "openai_decision_paper_enabled",
    "openai_decision_require_local_pass_first",
    "openai_managed_auto_tuning_enabled",
    "openai_nightly_review_enabled",
    "openai_nightly_review_apply_tuning_enabled",
    "openai_nightly_review_write_report_enabled",
    "openai_position_review_enabled",
    "openai_position_review_live_enabled",
    "openai_position_review_paper_enabled",
    "openai_position_review_auto_act_enabled",
    "openai_capital_planner_enabled",
    "openai_capital_planner_live_enabled",
    "openai_capital_planner_paper_enabled",
    "openai_root_cause_enabled",
    "openai_root_cause_live_enabled",
    "openai_explanations_enabled",
    "openai_explanations_live_enabled",
    "openai_strategy_optimizer_enabled",
    "openai_strategy_optimizer_live_enabled",
    "openai_strategy_optimizer_auto_apply_enabled",
    "openai_market_context_enabled",
    "openai_market_context_live_enabled",
...
_FLOAT_BOUNDS: Dict[str, Tuple[float, float, float]] = {
    ...
    "crypto_replay_adaptive_weight": (0.35, 0.0, 1.0),
    "crypto_replay_adaptive_step_cap_pct": (40.0, 5.0, 90.0),
    "crypto_min_calib_prob_live_guarded": (0.50, 0.0, 1.0),
    "crypto_allocator_signal_floor": (0.15, 0.01, 5.0),
    ...
    "openai_root_cause_timeout_s": (8.0, 1.0, 30.0),
    "openai_explanations_interval_s": (3600.0, 120.0, 604800.0),
    "openai_explanations_timeout_s": (6.0, 1.0, 30.0),
    "openai_strategy_optimizer_interval_s": (3600.0, 30.0, 604800.0),
    "openai_strategy_optimizer_timeout_s": (8.0, 1.0, 30.0),
    "openai_market_context_interval_s": (300.0, 30.0, 604800.0),
    "openai_market_context_timeout_s": (6.0, 1.0, 30.0),
    "openai_postmortem_interval_s": (86400.0, 300.0, 604800.0),
    "openai_postmortem_timeout_s": (12.0, 1.0, 60.0),
    ...
    "stock_same_day_exception_min_pnl_pct": (2.5, 0.0, 100.0),
...
_INT_BOUNDS: Dict[str, Tuple[int, int, int]] = {
    ...
    "openai_decision_max_candidates_per_market": (3, 1, 8),
    "openai_decision_max_calls_per_day": (24, 1, 5000),
    "openai_decision_max_calls_per_week": (120, 1, 50000),
    "openai_nightly_review_hour_local": (2, 0, 23),
    "openai_nightly_review_lookback_days": (7, 1, 30),
    "openai_nightly_review_max_events": (5000, 200, 50000),
    "openai_nightly_review_max_suggestions": (12, 3, 20),
    "openai_position_review_max_positions": (48, 8, 200),
    "openai_capital_planner_max_candidates_per_market": (3, 1, 8),
    "openai_root_cause_max_incidents": (300, 50, 2000),
    "openai_explanations_max_items": (18, 4, 64),
    "openai_market_context_max_items": (24, 6, 120),
    "openai_postmortem_max_events": (5000, 200, 50000),
        ...
        overrides.update(
            {
                ...
                "stock_min_hold_minutes": 4320,
                "stock_same_day_exit_exception_enabled": True,
                "stock_same_day_exception_min_hold_minutes": 180,
                "stock_same_day_exception_min_pnl_pct": 3.5,
                "stock_same_day_exception_min_pullback_pct": 1.2,
                "stock_same_day_exception_require_score_flip": True,
        ...
        overrides.update(
            {
                ...
                "stock_same_day_exit_exception_enabled": True,
                "stock_same_day_exception_min_hold_minutes": 150,
                "stock_same_day_exception_min_pnl_pct": 3.0,
                "stock_same_day_exception_min_pullback_pct": 1.0,
                "stock_same_day_exception_require_score_flip": True,
                "stock_same_day_exception_score_floor_mult": 0.85,
                "stock_pdt_equity_threshold_usd": 25_000.0,
                "stock_pdt_max_day_trades_rolling_5d": 3,
        ...
        overrides.update(
            {
                ...
                "stock_same_day_exception_min_pullback_pct": 0.9,
                "stock_same_day_exception_require_score_flip": True,
                "stock_same_day_exception_score_floor_mult": 0.80,
                "stock_pdt_equity_threshold_usd": 25_000.0,
                "stock_pdt_max_day_trades_rolling_5d": 3,
...
def sanitize_settings(raw: Dict[str, Any] | None, defaults: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    if isinstance(raw_overrides, str):
        ...
        overrides_seq = []
    out["profile_manual_overrides"] = sorted({k for k in overrides_seq if k in PROFILE_MANUAL_OVERRIDE_ALLOWLIST})
    ...
    if bool(out.get("openai_managed_auto_tuning_enabled", False)):
        if bool(out.get("openai_nightly_review_enabled", False)) or bool(out.get("openai_decision_enabled", False)):
            out["openai_nightly_review_apply_tuning_enabled"] = True
        if bool(out.get("openai_strategy_optimizer_enabled", False)) or bool(out.get("openai_decision_enabled", False)):
            out["openai_strategy_optimizer_auto_apply_enabled"] = True
        if bool(out.get("openai_postmortem_enabled", False)) or bool(out.get("openai_decision_enabled", False)):
            out["openai_postmortem_auto_apply_tuning_enabled"] = True
